...
a=5
mean_acc = np.zeros((a-1))
std_acc = np.zeros((a-1))
...
plt.plot(range(1,a),mean_acc,'g')
plt.fill_between(range(1,a),mean_acc - 1 * std_acc,mean_acc + 1 * std_acc, alpha=0.10)
...
KJ = jaccard_similarity_score(y, yhatKNN)
K = f1_score(y, yhatKNN, average='weighted')
print("Avg F1-score: %.2f" % K)
print("KNN Jaccard Score: %.2f" % KJ)
